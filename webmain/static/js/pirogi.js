...
const like_buttons = document.querySelectorAll('button.like > img');
...
//}
const modal_buttons = document.querySelectorAll('button.product-preview');
modal_buttons.forEach((button) => { button.onclick = function() {
    modal.style.display = "block";
//    modalImg.src = this.src;
};});
...
// Слайд картинок в модальном окне
var slideIndex = 1;
